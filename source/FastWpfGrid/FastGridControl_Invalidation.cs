...
namespace FastWpfGrid
{
    partial class FastGridControl
    {
        ...
        private readonly List<int> _invalidatedRows = new List<int>();
        private readonly List<int> _invalidatedColumns = new List<int>();
        private readonly List<Tuple<int, int>> _invalidatedCells = new List<Tuple<int, int>>();
        private readonly List<int> _invalidatedRowHeaders = new List<int>();
        private readonly List<int> _invalidatedColumnHeaders = new List<int>();
